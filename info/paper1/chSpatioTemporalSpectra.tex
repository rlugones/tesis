...
\begin{figure*}
  \centering
%  \subfigure[$B_0=0$]{\includegraphics[width=0.45\textwidth]{fig2_B0-eps-converted-to.pdf}}
%  \subfigure[$B_0=0.25$]{\includegraphics[width=0.45\textwidth]{fig2_B025-eps-converted-to.pdf}}

%  \subfigure[$B_0=1$]{\includegraphics[width=0.45\textwidth]{fig2_B1-eps-converted-to.pdf}}
%  \subfigure[$B_0=1$ with explanation]{\includegraphics[width=0.45\textwidth]{fig2_B1_explanation-eps-converted-to.pdf}}

%  \subfigure[$B_0=4$]{\includegraphics[width=0.45\textwidth]{fig2_B4-eps-converted-to.pdf}}
%  \subfigure[$B_0=8$]{\includegraphics[width=0.45\textwidth]{fig2_B8-eps-converted-to.pdf}}
  \subfigure[$B_0=0$]{\includegraphics[width=0.48\textwidth]{fig2_B0.pdf}}
  \subfigure[$B_0=1$]{\includegraphics[width=0.48\textwidth]{fig2_B1.pdf}}

  \subfigure[$B_0=4$]{\includegraphics[width=0.48\textwidth]{fig2_B4.pdf}}
  \subfigure[$B_0=4$ in log-log scale]{\includegraphics[width=0.48\textwidth]{fig2_B4_log.pdf}}
%  \subfigure[$B_0=4$ in log-log scale]{\includegraphics[width=0.45\textwidth]{fig2_B4_log.eps}}

  \subfigure[$B_0=8$]{\includegraphics[width=0.48\textwidth]{fig2_B8.pdf}}
  \subfigure[$B_0=8$ in log-log scale]{\includegraphics[width=0.48\textwidth]{fig2_B8_log.pdf}}
%  \subfigure[$B_0=8$ in log-log scale]{\includegraphics[width=0.45\textwidth]{fig2_B8_log.eps}}
...
\begin{figure}
  \centering
  \subfigure[$\Gamma(k_\perp=0,k_\parallel=k_0,\tau)$]{\includegraphics[width=1\columnwidth]{fig4_B1_b_kperp-eps-converted-to.pdf}}

  \subfigure[$\Gamma(k_\perp=k_0,k_\parallel=0,\tau)$]{\includegraphics[width=1\columnwidth]{fig4_B1_b_kpara-eps-converted-to.pdf}}
...
\begin{figure}
  \centering
  \subfigure[$k_\perp=0$]{\includegraphics[width=1\columnwidth]{fig5_B025_b_kperp_0-eps-converted-to.pdf}}

  \subfigure[$k_\perp=10$]{\includegraphics[width=1\columnwidth]{fig5_B025_b_kperp_10-eps-converted-to.pdf}}

  \subfigure[$k_\perp=20$]{\includegraphics[width=1\columnwidth]{fig5_B025_b_kperp_20-eps-converted-to.pdf}}
...
\begin{figure}
  \centering
  \subfigure[$k_\parallel=0$]{\includegraphics[width=1\columnwidth]{fig5_B025_b_kpara_0-eps-converted-to.pdf}}

  \subfigure[$k_\parallel=10$]{\includegraphics[width=1\columnwidth]{fig5_B025_b_kpara_10-eps-converted-to.pdf}}

  \subfigure[$k_\parallel=20$]{\includegraphics[width=1\columnwidth]{fig5_B025_b_kpara_20-eps-converted-to.pdf}}
  \caption{Decorrelation times $\tau_D$ for the run with
...
\begin{figure}
  \centering
  \subfigure[$k_\perp=0$]{\includegraphics[width=1\columnwidth]{fig5_B1_b_kperp_0-eps-converted-to.pdf}}

  \subfigure[$k_\perp=10$]{\includegraphics[width=1\columnwidth]{fig5_B1_b_kperp_10-eps-converted-to.pdf}}

  \subfigure[$k_\perp=20$]{\includegraphics[width=1\columnwidth]{fig5_B1_b_kperp_20-eps-converted-to.pdf}}
...
\begin{figure}
  \centering
  \subfigure[$k_\parallel=0$]{\includegraphics[width=1\columnwidth]{fig5_B1_b_kpara_0-eps-converted-to.pdf}}

  \subfigure[$k_\parallel=10$]{\includegraphics[width=1\columnwidth]{fig5_B1_b_kpara_10-eps-converted-to.pdf}}

  \subfigure[$k_\parallel=20$]{\includegraphics[width=1\columnwidth]{fig5_B1_b_kpara_20-eps-converted-to.pdf}}
  \caption{Decorrelation times $\tau_D$ for the run with $B_0=1$. In each
...
\begin{figure}
  \centering
  \subfigure[$k_\perp=0$]{\includegraphics[width=1\columnwidth]{fig5_B8_b_kperp_0-eps-converted-to.pdf}}

  \subfigure[$k_\perp=10$]{\includegraphics[width=1\columnwidth]{fig5_B8_b_kperp_10-eps-converted-to.pdf}}

  \subfigure[$k_\perp=20$]{\includegraphics[width=1\columnwidth]{fig5_B8_b_kperp_20-eps-converted-to.pdf}}
...
\begin{figure}
  \centering
  \subfigure[$k_\parallel=0$]{\includegraphics[width=1\columnwidth]{fig5_B8_b_kpara_0-eps-converted-to.pdf}}

  \subfigure[$k_\parallel=10$]{\includegraphics[width=1\columnwidth]{fig5_B8_b_kpara_10-eps-converted-to.pdf}}

  \subfigure[$k_\parallel=20$]{\includegraphics[width=1\columnwidth]{fig5_B8_b_kpara_20-eps-converted-to.pdf}}
  \caption{Decorrelation times $\tau_D$ for the run with $B_0=8$. In each
    panel $k_\parallel$ is held constant and $k_\perp$ is varied; (a)
    $k_\parallel = 0$, (b) $k_\parallel = 10$, and (c) $k_\parallel =
    20$. The straight lines indicate theoretical predictions for
