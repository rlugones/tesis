...
\begin{figure*}[<t>]
\begin{center}
{\includegraphics[width = 0.42\textwidth]{./Fig1_a}}
{\includegraphics[width = 0.42\textwidth]{./Fig1_b}}
...
\begin{figure}[<h!>]
\begin{center}
\hspace*{0.4cm}{\includegraphics[width = 3.31in]{./Fig2_a}}\\
{\includegraphics[width = 3.05in]{./Fig2_b}}\\
...
\begin{figure}[h!]
\begin{center}
{\includegraphics[width = 3.05in]{./Fig3_a}}
{\includegraphics[width = 3.05in]{./Fig3_b}}
...
\begin{figure}
\begin{center}
{\includegraphics[width = 2.3in]{./Fig4_b}}
{\includegraphics[width = 2.31in]{./Fig4_2}}
...
\begin{figure}[h!]
\begin{center}
{\includegraphics[width = 2.8in]{./Fig5_a}}
{\includegraphics[height=2.8in, width = 3in]{./Fig5_b}}
...
\begin{figure}[<t>]
\begin{center}
{\includegraphics[width = 3.3in]{./Fig7_a}}
{\includegraphics[width = 3.3in]{./Fig7_b}}
...
\bibliography{aipsamp_arxiv}% Produces the bibliography via BibTeX.
